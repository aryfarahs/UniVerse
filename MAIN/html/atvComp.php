...
<head>
    ...
    <script src="'..\js\atvComp.js'"></script>
    <link rel="stylesheet" href="../css/atvComp.css">
    ...
    <main>
        <div class="sideNav">
            <nav>
                <ul>
                    ...
                    <li class="sideSelect"><a href="atvComp.php">&nbsp;ATIVIDADES &nbsp;COMPLEMENTARES</a></li>
        ...
        <span id="codAviso">
            ...
            <div class="containerAC">
                <div class="navAtvComp">
                    <nav>
                        <ul>
                            <li class="atvCompSelect"><a>AVISOS</a></li>
                            <li><a id="aCalendar">CALENDÁRIO</a></li>
                            <li><a id="aProtocol">PROTOCOLOS</a></li>
                            <li><a id="aGrade">MINHA GRADE</a></li>
                        </ul>
                    </nav>
                </div>
                <section class="aviso">
                    <img src="../images/warning.png" alt="" width="100px">
            ...
            <div class="warnBox">
                <p>
                    <span class="subW">Atenção, estudantes de Graduação!</span>
                    <br><br>
                    ...
                    <span class="subW">Atenção, estudantes de Graduação e Pós-Graduação!</span>
                    <br><br>
                    ...
                    <span class="subW">Estudante de Pós-graduação Lato Sensu, a carteirinha também é para você!</span>
                    <br><br>
            ...
            <div class="compGraph">
                <p class="horas"><span style="font-size: 24px;">50/50 </span><br> HORAS COMPLETAS</p>
            </div>
